...
BEGIN
    CREATE TABLE Users (
        Id INT IDENTITY(1,1),
        Username NVARCHAR(150) NOT NULL UNIQUE,    -- Nombre de usuario �nico
        PasswordHash NVARCHAR(1000) NOT NULL,       -- Hash de la contrase�a
        RoleName NVARCHAR(50) NOT NULL,                -- Rol del usuario (Admin, User, etc.)
        CreationDate DATETIME NOT NULL DEFAULT GETDATE(), -- Fecha de creaci�n
        ModificationDate DATETIME NULL, -- Fecha de �ltima actualizaci�n
